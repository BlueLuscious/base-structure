...
class ActionInputWidget(forms.TextInput):
    ...
    readonly_display_extra_classes = ("core-action-input__display",)
    ...
    def get_context(self, name: str, value: Any, attrs: dict[str, Any] | None) -> dict[str, Any]:
        ...
        context["widget"]["is_readonly"] = self._is_readonly_attrs(context["widget"]["attrs"])
        context["widget"]["display_value"] = self._display_value(value)
        context["widget"]["display_classes"] = self._display_classes()
    ...
    def _is_readonly_attrs(self, attrs: dict[str, Any]) -> bool:
        ...
        """
        return bool(attrs.get("readonly") or attrs.get("disabled"))

    def _display_value(self, value: Any) -> str:
        """Return one display-safe value for readonly rendering.

        Args:
            value: Current widget value.

        Returns:
            str: Display value or a dash placeholder for empty values.
        """
    ...
    def _display_classes(self) -> str:
        """Return Unfold-compatible classes for readonly input values.

        Returns:
            str: CSS classes aligned with Unfold readonly fields.
        """
        return " ".join([*UNFOLD_READONLY_VALUE_CLASSES, *self.readonly_display_extra_classes])
